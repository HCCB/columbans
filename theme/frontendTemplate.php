     ...
     <div class="navbar navbar-fixed-top navbar-inverse" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo WEB_ROOT; ?>index.php">HCCB Online Grading and Student Information System</a>
        </div>
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-eye-open"></span>&nbsp; View<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="<?php echo WEB_ROOT; ?>index.php?page=2"><span class="glyphicon glyphicon-user"></span>&nbsp; Profile</a></li>
                  <li><a href="<?php echo WEB_ROOT; ?>index.php?page=3"><span class="glyphicon glyphicon-folder-open"></span>&nbsp; Record</a></li>
...
<hr>
      <footer>
        <p align="center">&copy; Holy Child Colleges of Butuan 2016 - <a href="http://wwww.sourcecodester.com/"></a></p>
