						...
						<?php
						 ...
						 ?>
						   ...
						   <div class="form-group">
				            <div class="col-md-8">
				              <label class="col-md-4 control-label" for=
				              "midterm">Pre-Final</label>

				              <div class="col-md-8">
				                 <input class="form-control input-sm" id="midterm" name="midterm"  onkeyup="calculate()"    type="text" value="<?php echo (isset($cur)) ? $cur->MID  : 'prefinal' ;?>">
				              </div>
				            </div>
				          </div>
				           <div class="form-group">
