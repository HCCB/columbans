	   ...
	   <div class="container">	
    	...
    	<form class="form-horizontal span4" action="" method="POST">
    		<table class="table" id="" align="center" >	 
			  <p><center> <b>HOLY CHILD COLLEGES OF BUTUAN </b><br>2nd St., Guingona Subd., Butuan City</p>
			  <h3><center> <b>REPORT OF RATING</h3>
				  ...
				  <tbody>				    
			     	...
			     	<!--	<td><?php //echo (isset($cur)) ? $cur->SEMESTER : 'Semester' ;?></td>-->
			     		<strong>Course:</strong> <?php echo (isset($cur)) ? $cur->COURSE_DESC : 'Course' ;?><br/>
