		...
		<?php
		 ...
		 ?>
           ...
           <div class="form-group">
            <div class="col-md-8">
              <label class="col-md-4 control-label" for=
              "third">Semi-Final</label>
              <div class="col-md-8">
                 <input class="form-control input-sm" id="third" name="third"  onkeyup="calculate();javascript:checkNumber(this);"  type="text" value="<?php echo number_format(isset($cur)) ? $cur->THIRD  : 'THIRD' ;?>">
              </div>
            </div>
          </div>
           <div class="form-group">
